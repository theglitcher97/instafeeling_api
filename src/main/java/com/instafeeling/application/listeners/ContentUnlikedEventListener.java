...
@Component
@AllArgsConstructor
public class ContentUnlikedEventListener {
    ...
    public void contentLikedEventListener(ContentUnlikedEvent event){
        this.notificationService.removeNotificationOnEvent(event.actorId(), event.contentId(), event.recipientId()  );
    }
}
